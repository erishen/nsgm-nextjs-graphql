...
export const BATCH_DEL_KNOWLEDGE = 'BATCH_DEL_KNOWLEDGE'
export const BATCH_DEL_KNOWLEDGE_SUCCEEDED = 'BATCH_DEL_KNOWLEDGE_SUCCEEDED'
export const BATCH_DEL_KNOWLEDGE_FAILED = 'BATCH_DEL_KNOWLEDGE_FAILED'